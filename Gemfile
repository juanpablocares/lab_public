...
#gema que instala bower en la aplicacion. Bower permite el manejo de paquetes front end de manera simple. (instalacion de angular y complementos mediante bower)
gem 'bower-rails'
